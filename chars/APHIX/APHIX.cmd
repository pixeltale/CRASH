...
triggerall = command = "ATTACK" && command = "holddown"
triggerall = statetype != A
trigger1 = ctrl || stateno = 200 && movecontact && prevstateno != 400 && prevstateno != 200 || stateno = 400 && movecontact

;j.2L: Jumping Light
[State -1, Jumping Down Light] ;j2L
type = ChangeState
value = 605
triggerall = command = "ATTACK" && command = "holddown"
triggerall = statetype = A
trigger1 = ctrl || stateno = [60, 61] || stateno = 600 && MoveContact
